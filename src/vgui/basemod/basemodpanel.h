...
// Nuclide VGUI compatibility port of Alien Swarm BaseModUI
// Original Valve C++ adapted to use Nuclide vguiWidget / vguiWindow base

#include "../Widget.h"
#include "../Window.h"
#include "../Frame.h"

// Valve types stubbed for Nuclide port
class KeyValues;
...
namespace BaseModUI 
{
	...
	//
	//=============================================================================
	class CBaseModPanel : public vguiWindow
	{
		// Ported from vgui::EditablePanel + IMatchEventsSink to Nuclide vguiWindow
	...
	public:
		virtual 		void OnEvent( /*KeyValues*/ void *pEvent );
	...
	public:
		...
		CBaseModFrame* OpenWindow( const WINDOW_TYPE& wt, CBaseModFrame * caller, bool hidePrevious = true, /*KeyValues*/ void *pParameters = NULL );
		CBaseModFrame* GetWindow( const WINDOW_TYPE& wt );
		// TODO: implement using Nuclide vguiWidget list + WINDOW_TYPE registry
