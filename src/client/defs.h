...
var float autocvar_pm_thirdPersonDist = 128;
var float autocvar_pm_thirdPersonSide = 4;
var float autocvar_pm_thirdPersonUp = 8;
...
struct
{
	...
	bool m_iInputHeroMelee;
	bool m_iInputHeroTool;
	bool m_iInputHeroGuard;
	bool m_iInputGroove;
