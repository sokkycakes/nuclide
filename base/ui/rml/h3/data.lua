-- Auto-generated from web/h3-main-menu/data.json
return {
  ...
  list = {
    ...
    row_unfocused_color = {0.698, 0.78, 1.0},
    ...
    items = {
      {
        id = "start_new_campaign",
        label = "START SOLO GAME",
        destination = "campaign_select_difficulty",
      },
      {
        id = "resume_campaign",
        label = "RESUME SOLO GAME",
        destination = "campaign_loading",
        hidden_by_default = true,
        _reason = "engine hides until a save file exists",
      },
      {
        id = "campaign",
        label = "CAMPAIGN",
        destination = "pregame_lobby_campaign",
      },
      {
        id = "matchmaking",
        label = "MATCHMAKING",
        destination = "pregame_lobby_matchmaking",
      },
      {
        id = "multiplayer",
        label = "CUSTOM GAMES",
        destination = "pregame_lobby_multiplayer",
      },
      {
        id = "mapeditor",
        label = "FORGE",
        destination = "pregame_lobby_mapeditor",
      },
      {
        id = "theater",
        label = "THEATER",
        destination = "pregame_lobby_theater",
      },
      {
        id = "locked",
        label = "PLAY THE BETA",
        destination = "alpha_locked_down",
        disabled = true,
        hidden_by_default = true,
        _reason = "Recon/ODST beta promo only",
      },
      {
        id = "leave_game",
        label = "QUIT TO XBOX DASHBOARD",
        destination = "_quit",
        hidden_by_default = true,
        _reason = "engine hides off-Xbox",
      },
    },
  },
  button_keys = {
  ...
  left_group_chrome = {
    ...
    bottom_gradient = {
      src = "assets/bottom_gradient.png",
      top = 595,
      left = 78,
      bottom = 640,
      right = 385,
  ...
  animations = {
    ...
    slide_up = {
      ...
      property = "position",
      _source = "ui\\halox\\main_menu\\animations\\slide_up.gui_widget_position_animation_definition",
    },
    slide_down = {
      keyframes = {
        {
      ...
      property = "position",
      _source = "ui\\halox\\main_menu\\animations\\slide_down.gui_widget_position_animation_definition",
    },
    lobby_slide_in = {
      keyframes = {
        {
      ...
      property = "position",
      _source = "ui\\halox\\pregame_lobby\\animations\\lobby_slide_in.gui_widget_position_animation_definition",
    },
    lobby_slide_out = {
      keyframes = {
        {
      ...
      property = "position",
      _source = "ui\\halox\\pregame_lobby\\animations\\lobby_slide_out.gui_widget_position_animation_definition",
    },
    subtle_pulsate = {
      keyframes = {
        {0, 1},
    ...
    template = {
      ...
      visual = {
        ...
        list = {
          ...
          _disabled_unfocused_source = "ui\\halox\\common\\standard_list\\unfocused_listitem.wclr (0.25 alpha — disabled rows only)",
      ...
      roster_720p = {
        top = 64,
        right_from_canvas = 437,
        _note = "right-edge anchored: bounds 720p=64,843,0,0 -> 1280-843=437px from left, but right-edge anchor pins to right side",
      },
      ...
      roster = {
        ...
        slot_count = 16,
        slot_pitch_720p = 32,
        slot_content_extent_720p = {
          left = -63,
          right = 250,
          width = 313,
          _note = "ring_of_light at x=-63 is the leftmost element; party_bar_player at x=250 is the rightmost",
        },
        ...
        skin_elements = {
          ...
          name_hilite = {
            ...
            justify = "left",
            color_preset = "hilite",
            _css = ".roster-slot__name (focused state)",
          },
          service_tag = {
            kind = "text",
            bounds_720p = {
          ...
          press_a_to_join = {
            ...
            font = "body text",
            color_preset = "dim",
            _css = ".roster-slot__empty-prompt (data-state=empty)",
          },
          looking_for_player = {
            kind = "text",
            bounds_720p = {
            ...
            font = "body text",
            color_preset = "semi_dim",
            _css = ".roster-slot__searching-text (data-state=searching)",
          },
          player_found = {
            kind = "text",
            bounds_720p = {
            ...
            font = "body text",
            color_preset = "white",
            _css = ".roster-slot__found-text (data-state=found)",
          },
          base_color = {
            kind = "bitmap",
            bounds_720p = {
            ...
            bitmap = "ui\\halox\\common\\roster\\roster_unfocused_ui",
            _css = ".roster-slot__base",
          },
          base_color_hilite = {
            kind = "bitmap",
            bounds_720p = {
            ...
            bitmap = "ui\\halox\\common\\roster\\roster_focused_ui",
            _css = ".roster-slot__base (data-focused=true)",
          },
          player_emblem = {
            kind = "bitmap",
            bounds_720p = {
            ...
            bitmap = "ui\\halox\\common\\common_bitmaps\\emblems",
            flags = "render_as_player_emblem, scale_to_fit",
            _css = ".roster-slot__emblem",
          },
          player_emblem_hilite = {
            ...
            bitmap = "ui\\halox\\common\\common_bitmaps\\emblems",
            _css = ".roster-slot__emblem (focused)",
          },
          rank_tray = {
            kind = "bitmap",
            bounds_720p = {
            ...
            bitmap = "ui\\halox\\common\\roster\\rank_tray_ui",
            _css = ".roster-slot__rank-tray",
          },
          rank_tray_hilite = {
            kind = "bitmap",
            bounds_720p = {
            ...
            bitmap = "ui\\halox\\common\\roster\\rank_tray_ui",
            sprite_frame = 1,
            _css = ".roster-slot__rank-tray (focused)",
          },
          skill_level = {
            kind = "bitmap",
            bounds_720p = {
            ...
            bitmap = "ui\\halox\\common\\roster\\lvl_sm_ui",
            _css = ".roster-slot__skill",
          },
          skill_level_hilite = {
            kind = "bitmap",
            bounds_720p = {
            ...
            bitmap = "ui\\halox\\common\\roster\\lvl_sm_ui",
            _css = ".roster-slot__skill (focused)",
          },
          experience = {
            kind = "bitmap",
            bounds_720p = {
            ...
            bitmap = "ui\\halox\\common\\roster\\exp_med_ui",
            _css = ".roster-slot__exp",
          },
          experience_hilite = {
            kind = "bitmap",
            bounds_720p = {
          ...
          party_bar_player = {
            ...
            bitmap = "ui\\halox\\common\\roster\\partybar_ui",
            _css = ".roster-slot__party-bar",
          },
          ring_of_light = {
            kind = "bitmap",
            bounds_720p = {
            ...
            bitmap = "ui\\halox\\common\\roster\\ringspeak_ui",
            _css = ".roster-slot__ring (data-speaking=true)",
          },
          outer_ring = {
            kind = "bitmap",
            bounds_720p = {
            ...
            bitmap = "ui\\halox\\common\\roster\\outer_ring_ui",
            _css = ".roster-slot__ring-outer (searching)",
          },
          middle_ring = {
            kind = "bitmap",
            bounds_720p = {
            ...
            bitmap = "ui\\halox\\common\\roster\\middle_ring_ui",
            _css = ".roster-slot__ring-middle (searching)",
          },
          party_up = {
            kind = "bitmap",
            bounds_720p = {
            ...
            bitmap = "ui\\halox\\common\\roster\\roster_flashy_ui",
            _css = ".roster-slot__party-up (party-up flash)",
          },
          check = {
            kind = "bitmap",
            bounds_720p = {
            ...
            bitmap = "ui\\halox\\common\\roster\\blankcheck_ui",
            _css = ".roster-slot__check",
          },
          player_found_bitmap = {
            kind = "bitmap",
            bounds_720p = {
            ...
            bitmap = "ui\\halox\\common\\roster\\matchmaking",
            sprite_frame = 1,
            _css = ".roster-slot__found-bitmap",
          },
          looking_for_player_bitmap = {
            kind = "bitmap",
            bounds_720p = {
              top = 0,
              left = -36,
            ...
            bitmap = "ui\\halox\\common\\roster\\matchmaking",
            sprite_frame = 0,
            _css = ".roster-slot__searching-bitmap",
          },
        },
        states = {
        ...
        _export_status = "Tag XML exported to exported/roster_nameplate_tags_xml/. Bitmaps exported to assets/roster/ — all are RGBA WHITE ALPHA MASKS (RGB=255,255,255, alpha varies) that the engine tints at runtime, so the CSS uses them as mask-image with a colored layer underneath.",
        exported_bitmaps = {
          roster_unfocused_ui = {
            file = "assets/roster/roster_unfocused_ui.png",
            size_px = {284, 31},
            mode = "RGBA alpha mask (white)",
            _note = "Base nameplate strip. 31px tall matches our 32px slot pitch exactly. Alpha is brightest at the top and fades to transparent at the bottom, giving the angled-bottom look retail H3 has.",
          },
          roster_focused_ui = {
            file = "assets/roster/roster_focused_ui.png",
            size_px = {286, 228},
            mode = "RGBA alpha mask (black)",
            _note = "Focused-state halo. Much taller than a single row (228 ~= 7 rows worth) - it's the soft black halo that bleeds above/below the focused row.",
          },
          rank_tray_ui = {
            file = "assets/roster/rank_tray_ui.png",
            size_px = {114, 48},
            mode = "L (greyscale)",
            _note = "Rank tray angular shape, recolored by the engine. 48px tall = bleeds 8px above + 8px below a 32px row.",
          },
          partybar_ui = {
            file = "assets/roster/partybar_ui.png",
            size_px = {48, 962},
            mode = "RGBA alpha mask",
            _note = "Tall sprite sheet of party-bar states (multiple frames stacked vertically).",
          },
          exp_med_ui = {
            file = "assets/roster/exp_med_ui.png",
            size_px = {418, 212},
            mode = "RGBA alpha mask",
            _note = "Sprite sheet of exp meter frames.",
          },
          lvl_sm_ui = {
            file = "assets/roster/lvl_sm_ui.png",
            size_px = {250, 122},
            mode = "RGBA alpha mask",
            _note = "Sprite sheet of skill level icons (chevrons/numerals).",
          },
          ringspeak_ui = {
            file = "assets/roster/ringspeak_ui.png",
            size_px = {82, 112},
            mode = "RGBA alpha mask",
            _note = "Speaking-ring frames.",
          },
        },
        _base_render_rule = "base_color is unconditional — ALL 16 slots render the roster_unfocused_ui strip the same way, whether empty or filled. The 'PRESS A TO JOIN' text widget just overlays on top of the same strip for empty slots; no separate dimmed treatment for the strip itself.",
      },
      button_keys = {
        {
          glyph = "B",
    ...
    modes = {
      campaign = {
        ...
        items = {
          ...
          {
            id = "select_network_mode",
            label = "NETWORK",
            value = "Offline",
            target = "network_mode",
          },
          {
            id = "switch_campaign_level",
            label = "LEVEL",
            value = "The Storm",
            target = "level",
          },
          {
            id = "switch_campaign_difficulty",
            label = "DIFFICULTY",
            value = "Heroic",
            target = "difficulty",
          },
      ...
      multiplayer = {
        ...
        items = {
          ...
          {
            id = "switch_multiplayer_game",
            label = "GAME",
            value = "Slayer",
            target = "variant",
          },
          {
            id = "switch_multiplayer_map",
            label = "MAP",
            value = "Valhalla",
            target = "map",
          },
